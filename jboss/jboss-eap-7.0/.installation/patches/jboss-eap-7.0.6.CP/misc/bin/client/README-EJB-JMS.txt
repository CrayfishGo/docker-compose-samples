jboss-client.jar is a combined client jar for JBoss EAP7, for use in non-maven environments. This jar should be used
with standalone clients only, not with deployments are that deployed to an EAP7 instance.
